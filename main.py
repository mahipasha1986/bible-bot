...
async function searchWord(){
  ...
  try{
    ...
    document.getElementById("wordStatus").innerText = "🔍 این مورد یافت نشد. خادمین در حال گسترش آرشیو هستند.";
    ...
    document.getElementById("wordStatus").innerText = "❌ اتصال به جستجو برقرار نشد.";
  }
}
