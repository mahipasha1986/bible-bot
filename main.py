...
[{"text": "✨ نسخه حرفه‌ای سرودها", "web_app": {"url": WEBAPP_URL}}],
...
به بخش سرودهای ربات «کلمه‌یاب و سرودیاب» خوش آمدید.

<br>

از گزینه‌های زیر می‌توانید سرودهای مناسبتی،

لیست کامل سرودها

یا

«یک سرود برام انتخاب کن»
...
<button class="gold">✝️ سرودهای عید قیام</button>


<button class="blue">🎄 سرودهای تولد مسیح</button>


<button class="red">🩸 سرودهای جمعه صلیب</button>


<button class="green" onclick="loadSongs()">
...
<button class="purple" onclick="randomSong()">
...
برای دریافت سرود، روی نام آن بزنید.
...
div.onclick = () => sendSong(song.index);
...
alert('✅ سرود در تلگرام برای شما ارسال شد.');

}else{

alert('❌ ارسال سرود انجام نشد.');
...
"callback_data": f"songpage|{page - 1}"
...
{"text": "⬅️ برگشت", "callback_data": "songs_menu"}
...
f"🎵 هنوز سرودی برای این مناسبت ثبت نشده است:\n\n{cat_value}"
...
"🏠 از منوی پایین، بخش مورد نظر را انتخاب کنید.",
...
"🙏 ممنون از اینکه در دعا همراه شدید.\nخداوند برکتتان دهد 🤍"
