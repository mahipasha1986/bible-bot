...
<head>
  ...
  <title>نسخه حرفه‌ای سرودها</title>
...
<body>
  <div class="card">
    <h1>🎼 نسخه حرفه‌ای سرودها</h1>
    <p>
      این صفحه تست WebApp ربات شماست.<br>
      اینجا می‌توانیم دکمه‌های رنگی واقعی، جستجوی زنده و پلیر سرود بسازیم.
    </p>
    ...
    <button class="green">🎼 لیست کامل سرودها</button>
    <button class="purple">🎵 سرود تصادفی</button>
  </div>
